...
1. **Удалите существующую переменную:**
   ...
   **Вариант 1:** В боковом меню проекта (слева) найдите **"Environment Variables"** или **"Variables"**

   **Вариант 2:** В верхнем меню проекта найдите вкладку **"Settings"** (или иконку шестеренки ⚙️), затем внутри найдите **"Environment Variables"**

   **Вариант 3:** При создании/редактировании проекта в разделе **"Environment Variables"** или **"Build & Development Settings"**
...
2. **Добавьте новую переменную правильно:**
   ...
   - Нажмите "Add New" (или "Add Variable")
   - В поле "Key" (или "Name") введите: `VITE_API_BASE`
   - В поле "Value" вставьте **реальный URL вашего backend** из Render
     - Например: `https://moonsalon-backend.onrender.com` (ваш реальный URL!)
   - ⚠️ **НЕ используйте примеры** - используйте ваш реальный URL из Render Dashboard!
